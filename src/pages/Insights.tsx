  ...
  return <div className="min-h-screen bg-background pt-16">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          {chartData.map((chart, index) => <motion.div key={chart.title} initial={{
          opacity: 0,
          y: 30
        }} animate={{
          opacity: 1,
          ...
          delay: 0.2 + index * 0.1
              ...
              <Card className="p-6 bg-gradient-card border-border/50 h-80">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Badge variant={chart.type === 'increase' ? 'destructive' : 'secondary'} className="flex items-center space-x-1">
                    {chart.type === 'increase' ? <TrendingUp className="h-3 w-3" /> : <TrendingDown className="h-3 w-3" />}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              delay: 0.7 + index * 0.1
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Badge variant={insight.severity === 'Critical' ? 'destructive' : insight.severity === 'High' ? 'secondary' : 'outline'} className={insight.bgColor}>
